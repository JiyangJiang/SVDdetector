...
switch ud2param.ud.classification.ext_space
	case 'dartel'
		...
		flair  = fullfile (ud2param.dirs.subjs, ud2param.lists.subjs{i,1}, 'ud', 'preproc', 'wrflair_brn.nii');
		t1     = fullfile (ud2param.dirs.subjs, ud2param.lists.subjs{i,1}, 'ud', 'preproc', 'wt1_brn.nii');
